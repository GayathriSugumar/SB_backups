...
<body>
  <h1>Your Ordinance Selection Details Here!....</h1>
  ...
  <script>
    ...
    console.log(test);
    localStorage.setItem("agreementValue", "Ordinence");
...
<script>
  ...
  const keys = [
    "agreementValue",
    "ordinanceunlimitedTextarea",
    "ordinancefile_upload"
  ];
  ...
  updateTable();
  localStorage.setItem("agreementValue", "Ordinance");
