...
<body>
  ...
  <script>
    ...
    console.log(test);
    localStorage.setItem("agreementValue", "Review Document and Comment/Advise");
  </script>
<script>
...
//Call the updateTable function initially to populate the table
  ...
  // Set the agreement value in the local storage if it doesn't exist
  if (!localStorage.getItem("agreementValue")) {
    localStorage.setItem("agreementValue", "Review Document and Comment/Advise");
  }

  // Add event listener to clear the specified keys from the local storage when the page is refreshed
  ...
  // Refresh the table after the page is reloaded
