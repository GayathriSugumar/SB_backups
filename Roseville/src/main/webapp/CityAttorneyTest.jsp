...
<body>
	<h1>Your City Attorney Selection Details Here!....</h1>
    ...
    console.log(test);
    localStorage.setItem("agreementValue", "City Attorney Signature and Routing Only");
  </script>
	<script>
