...
<title>Other Legal Service</title>
<style>
h3{
 margin-left: 15%;
}
...
<body>
<form id="upload_form" action="ordinance" method="post">
	<h1 style="color:rgb(7, 7, 73);"><u><span class="heading">Step 3: Other Legal Service</span></u></h1>
	...
	<h3><span class="required">*</span>Please describe what you are requesting:</h3>
		...
		<textarea id="myTextarea" name="unlimitedTextarea" rows="4" cols="50" required></textarea>
